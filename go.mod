...
require (
	...
	github.com/opengovern/og-describer-template v0.0.0-20250117160014-4faa25d5a9fd
	github.com/opengovern/og-util v1.11.0
	github.com/opengovern/resilient-bridge v0.0.0-20250117221239-f229577d01c7
