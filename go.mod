...
require (
	...
	github.com/opengovern/og-describer-template v0.0.0-20241228200056-40193f0ee6bd
	github.com/opengovern/og-util v1.7.2
	github.com/opengovern/resilient-bridge v0.0.0-20241223164256-e5927e58a22c
...
require (
	...
	github.com/opengovern/og-describer-cohereai v0.3.1 // indirect
