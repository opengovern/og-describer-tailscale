...
import (
	...
	"flag"
	"fmt"
	"github.com/opengovern/og-describer-tailscale/global"
	"go/ast"
	"go/format"
	"go/parser"
	"go/token"
...
//var PluginPath = "/mnt/c/Users/ASUS/GolandProjects/og-describer-tailscale/cloudql/tailscale"
...
func main() {
	if output == nil || len(*output) == 0 {
		...
		//v := "/mnt/c/Users/ASUS/GolandProjects/og-describer-tailscale/discovery/pkg/es/resources_clients.go"
		output = &v
	}
	if file == nil || len(*file) == 0 {
		v := "../../../provider/model.go"
		//v := "/mnt/c/Users/ASUS/GolandProjects/og-describer-tailscale/discovery/provider/model.go"
		file = &v
	}
	...
	if resourceTypesFile == nil || len(*resourceTypesFile) == 0 {
		...
		//rt := "/mnt/c/Users/ASUS/GolandProjects/og-describer-tailscale/global/maps/resource-types.json"
